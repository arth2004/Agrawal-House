...
export default function AdminRoomsPage() {
  ...
  const handleSaveRoom = async (e: React.FormEvent) => {
    ...
    const roomPayload: Room = {
      ...
      photos: editingRoom
        ? editingRoom.photos
        : ["/images/room_mango_suite.jpg"], // default photo if new
      status,
    };
      ...
      >
        <div>
          ...
          <p style={{ color: "var(--text-secondary)" }}>
            Add or modify homestay chambers, configure details, pricing, and
            status.
          </p>
        </div>
        ...
        {rooms.map((room) => (
          <div
            ...
            style={{
              ...
              opacity: room.status === "inactive" ? 0.75 : 1,
            }}
          >
              ...
              >
                ...
                <button
                  ...
                  style={{
                    ...
                    flex: 1,
                    color:
                      room.status === "active" ? "#EF4444" : "var(--secondary)",
                    borderColor:
                      room.status === "active"
                        ? "#FCA5A5"
                        : "var(--secondary-light)",
